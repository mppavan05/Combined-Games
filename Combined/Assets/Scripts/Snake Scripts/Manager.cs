...
namespace Snake_Scripts
{
    public class Manager : MonoBehaviour
    {
        ...
        public void StartGame()
        {
            ...
            coroutine = Counter(1, () => { txCounter.GetComponent<TMP_Text>().text = "2"; background.CrossFadeAlpha(0, 3.0f, false); }, new Action[2] {
                () => coroutine = Counter(1, () => { txCounter.GetComponent<TMP_Text>().text = "1"; }, new Action[2] {
        ...
        {
            txScore.GetComponent<TMP_Text>().text = $"Score: {scoreCounter.ToString()}";
        ...
        public void Crash()
        {
            ...
            endScreen.transform.GetChild(1).GetComponent<TMP_Text>().DOFade(1, 3.0f);
            endScreen.transform.GetChild(2).GetComponent<Image>().DOFade(1, 3.0f);
            endScreen.transform.GetChild(2).transform.GetChild(0).GetComponent<TMP_Text>().DOFade(1, 3.0f);
            endScreen.transform.GetChild(3).GetComponent<Image>().DOFade(1, 3.0f);
            endScreen.transform.GetChild(3).transform.GetChild(0).GetComponent<TMP_Text>().DOFade(1, 3.0f);
        }
